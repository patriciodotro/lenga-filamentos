        ...
        {resultado&&(
          <div style={{background:"#0d0d0d",borderRadius:10,padding:"18px",border:"1px solid #252525"}}>
            ...
            <div style={{borderTop:"1px solid #1a1a1a",paddingTop:12,display:"flex",flexDirection:"column",gap:6}}>
              ...
              {resultado.tiempoH>0&&<div style={{fontSize:11,color:"#444",marginTop:4}}>Precio/hora: <strong style={{color:"#666"}}>{resultado.tiempoH>0?fmtARS(resultado.subtotal/resultado.tiempoH):"-"}</strong></div>}
            </div>
          </div>
        )}
      </div>
